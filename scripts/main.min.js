...
" (sa)");$("#storedPlanFlightTime").val(a[b].flight_time);$("#storedPlanEndurance").val(a[b].endurance);$("#storedPlanPersons").val(a[b].persons);$("#storedPlanDepMethod").val(a[b].activation_method);$("#storedPlanArrMethod").val(a[b].completion_method);a[b].activation_method!==BY_PHONE_ON_GROUND_STR&&a[b].completion_method!==BY_PHONE_ON_GROUND_STR?$("#callAccButton").hide():$("#callAccButton").show()})}
