...
BY_PHONE_ON_GROUND_STR="PHONE ACC 032865172 ",BY_RTF_ON_AIR_STR="RTF ACC ",BY_TWR="- (torni)",overrideFlightTime=!0;function debug_log(a){log+=a+"<br>";document.getElementById("log").innerHTML=log}function getFlightTimeOverride(){return overrideFlightTime}
