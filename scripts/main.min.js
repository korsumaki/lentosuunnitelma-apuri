var log="",VfrRepArray,CurrentAerodromeArray,OfficialAerodromeArray,ZZZZFieldArray,gPosition_lat,gPosition_lon,flightPlanLink,gCalculatedFlyingTimeStr,gSelectedFlyingTimeStr,dateOfUpdateStr="2015-05-28T00:00:00Z",VFRPortFilename_before_change="EF_VFRREP_13NOV2014.xml",AerodromesFilename_before_change="aerodromes_13NOV2014.xml",ZZZZFieldsFilename_before_change="zzzz_fields_13NOV2014.xml",VFRPortFilename="EF_VFRREP_13NOV2014.xml",AerodromesFilename="aerodromes_28MAY2015.xml",ZZZZFieldsFilename="zzzz_fields_28MAY2015.xml",
...
function getNotam(a,b){document.getElementById(b).innerHTML="";$.getJSON("https://api.openaviationdata.com/v2/notam/facility?icao="+a+"&key="+OPENAVIATIONDATA_APIKEY,function(a,d,e){if(200==a.code){d='<ul data-role="listview">';for(e=0;e<a.data.length;e++)d+="<li>",d+=a.data[e].facility_icao+"=== ",d+=a.data[e].report,d+="</li>";d+="</ul>";document.getElementById(b).innerHTML=d}})}
