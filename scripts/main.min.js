...
function onLoad(){total_startup_start_time=debug_timestamp_start("onLoad");var a=new Date(dateOfUpdateStr);(new Date).getTime()<a.getTime()&&(VFRPortFilename=VFRPortFilename_before_13NOV2014,AerodromesFilename=AerodromesFilename_before_13NOV2014,ZZZZFieldsFilename=ZZZZFieldsFilename_before_13NOV2014);aerodromeXml_start_time=debug_timestamp_start("aerodromeXml load start");loadXMLDoc(AerodromesFilename,aerodromeXmlResponseHandler);navigator.geolocation?updateCurrentLocation():(debug_log("Geolocation ei ole tuettu selaimessa."),
