var log="Ohjelmakoodi p\u00e4iv\u00e4tty: 2015-05-21<br>",VfrRepArray,CurrentAerodromeArray,OfficialAerodromeArray,ZZZZFieldArray,gPosition_lat,gPosition_lon,flightPlanLink,gCalculatedFlyingTimeStr,gSelectedFlyingTimeStr,dateOfUpdateStr="2016-01-01T00:00:00Z",VFRPortFilename_before_change="data/EF_VFRREP_12NOV2015.xml",AerodromesFilename_before_change="data/aerodromes_01JAN2016.xml",ZZZZFieldsFilename_before_change="data/zzzz_fields_28MAY2015.xml",VFRPortFilename="data/EF_VFRREP_12NOV2015.xml",AerodromesFilename=
"data/aerodromes_01JAN2016.xml",ZZZZFieldsFilename="data/zzzz_fields_28MAY2015.xml",UNOFFICIAL_AERODROME="ZZZZ",UNOFFICIAL_AERODROME_INDEX=0,BY_PHONE_ON_GROUND_STR="PHONE ACC ",BY_PHONE_ON_GROUND_STR_WITH_PHONE="PHONE ACC 032865172 ",BY_RTF_ON_AIR_STR="RTF ACC ",BY_TWR="- (torni)",NOTE_TO_ADD_ACC_FREQ_STR="LIS\u00c4\u00c4_ACC_JAKSO",PYROTECHNICS_NOTE_REMARKS="rakettipelastusvarjo",OPENAVIATIONDATA_APIKEY="mkXQV7UpiiBgOVjxbTzioYfpOlNVtEtg",overrideFlightTime=!0,total_startup_start_time=0,aerodromeXml_start_time=
0;function debug_log(a){log+=a+"<br>";document.getElementById("log").innerHTML=log}function debug_timestamp_start(a){return(new Date).getTime()}function debug_timestamp_ready(a,b){(new Date).getTime()}function getFlightTimeOverride(){return overrideFlightTime}
